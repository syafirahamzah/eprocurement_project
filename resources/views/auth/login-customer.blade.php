...
<div class="relative bg-white p-10 rounded-md shadow-2xl w-full max-w-sm">
    <!-- Tombol Close -->
 ...
 <!-- Remember Me -->
        <div class="block mt-4">
            ...
            <div class="text-center mt-6 text-sm text-gray-600">
                Tidak punya akun? <a href="{{ route('register.customer') }}" class="text-indigo-600 hover:underline">Daftar Disini</a>
            </div>
        </form>
    </div>
</div>
